...
(function (global, factory) {
  ...
  var listener = throttle(function (sorted, targetVmSet, targetElSet, top, right, bottom, left, y, x) {
    lazyHandler(sorted, targetVmSet, targetElSet, top !== undefined ? function (el) {
  ...
  function lazyHandler(sorted, targetVmSet, targetElSet, checkFn) {
    // components
    var flag = false;
  ...
  var index = {
    install: function install(app) {
      ...
      Object.keys(baseConfig).forEach(function (k) {
        return options[k] != undefined && (baseConfig[k] = options[k]);
      });
      Object.keys(config).forEach(function (k) {
        return options[k] != undefined && (config[k] = options[k]);
      });
