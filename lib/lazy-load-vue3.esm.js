...
import { defineComponent, nextTick, h, onUpdated, getCurrentInstance, onBeforeUnmount, ref } from 'vue';
...
function updateDirectiveEl(el, isDelete, targetElSet) {
  ...
  if (targetElSet) {
    ...
    var _iterator2 = _createForOfIteratorHelper(lazyKeyElSetMap),
        _step2;
...
function updateComponentVm(vm, isDelete, targetVmSet) {
  ...
  if (targetVmSet) {
    ...
    var _iterator3 = _createForOfIteratorHelper(lazyKeyVmSetMap),
        _step3;
...
function throttle(cb) {
  ...
  var handler = function handler(sorted, event) {
    if (event && ![window, document].includes(event.target)) {
      ...
      var _iterator6 = _createForOfIteratorHelper(lazyKeyVmSetMap),
          _step6;
      ...
      var _iterator7 = _createForOfIteratorHelper(lazyKeyElSetMap),
          _step7;
...
function findSet(target, map) {
  ...
  var _iterator8 = _createForOfIteratorHelper(lazyKeySet),
      _step8;

  try {
    for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
      var lazyKey = _step8.value;
...
var LazyComponent = defineComponent({
  ...
  setup: function setup(props) {
    ...
    onBeforeUnmount(function () {
      return lazyKeyVmSetMap.forEach(function (vmSet) {
