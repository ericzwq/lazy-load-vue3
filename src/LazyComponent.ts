...
import {addComponentRecords, config, inViewPort, lazyKeyVmSetMap, updateComponentVm} from "./listen";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    onBeforeUnmount(() => lazyKeyVmSetMap.forEach(vmSet => vmSet.delete(getCurrentInstance()?.proxy as ExtComponentPublicInstance)))
